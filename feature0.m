function [fetr0]=feature0(I)
as00=I;
za=waitbar(0,'Extracting feature for 0 degree tracing .....');  
[m,n]=size(as00);
I1=as00;
...
for i = 1:m
 ...
 fetr0 = [asm0 contrast entropy idm dis mp GLCM variance CC];
%  filename = 'fetr0.xlsx';
%  xlRange1 = 'A35:I35';
%  xlswrite(filename,fetr0,xlRange1)

disp ('FEATURES OF DEGREE 0'); 
display (contrast);
display (idm);
display (dis);
display (entropy);
